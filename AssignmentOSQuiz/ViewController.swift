...
class ViewController: UIViewController {
    ...
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        ...
        else{answerLabel.isHidden = false }      // else set it not hidden
              }
    ...
    @IBAction func nextButtonPressed(_ sender: UIButton) {
        ...
        else{currentQuestion = 0}    // else set currentQuestion to 0
        updateUI()
    }
    ...
    func updateUI() {
        questionLabel.text = quizBank[currentQuestion].0   // set questionLabel's text to equal quizBank[currentQuestion].0
        answerLabel.text = quizBank[currentQuestion].1     // set answerLabel's text to equal quizBank[currentQuestion].1
        answerLabel.isHidden = true    // then set answerLabel to be hidden
       }
